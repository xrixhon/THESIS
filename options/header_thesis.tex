...
% -- Figures -------------------------------------------------------
\usepackage{graphicx}
\graphicspath{{frontend/img/}{chap_intro_ccl/img/}{chap1_ES_PCE/img/}{chap2_electro_uq/img/}{chap3_myopic/img/}{chap4_RL/img/}} % Figures folder different for each input
%\graphicspath{{img/}} %
