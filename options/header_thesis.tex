...
\newcommand{\mytitle}{Robust optimisation of the pathway\\ towards a sustainable whole-energy system}
\newcommand{\mysubtitle}{A hierarchical multi-objective \\reinforcement-learning based approach}
...
% -- Figures -------------------------------------------------------
\usepackage{graphicx}
\graphicspath{{frontend/img/}{chap1_electro_uq/img/}{chap2_myopic/img/}{chap3_RL/img/}{chap4_app/img/}{chap5_smold/img/}{chap6_model/img/}} % Figures folder different for each input
%\graphicspath{{img/}} %
...
\usepackage[labelfont=bf, labelsep=period, justification=centering]{caption} % style et taille de police des captions
