...
In the transport of freight, the ROB roadmap transition from diesel to \gls{FC} trucks with the use of electric trucks from 2025 to 2035. Similarly to the industrial electric heaters, it is a way to integrate to early installation of solar \gls{PV} and absorb part of its intermittent electricity. Freight transport via trains and boats are not different from the REF roadmap. About the passenger mobility, compared to the REF case, the shift from \gls{ICE} cars to \gls{BEV} occurs earlier in the transition, in line with the increased production of intermittent electricity from \gls{VRES}. \\
