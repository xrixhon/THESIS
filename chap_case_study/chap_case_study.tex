...
\begin{figure}[htbp!]
\centering
\includegraphics[width=\textwidth]{NED_hist.pdf}
...
Not digging into too much more details about the exhaustive list of these technologies presented in a previous work \cite{limpens2021generating}, this section rather focuses on the implementation of \glsxtrfull{SMR} and the technologies to supply the \glsxtrfull{NED}.
